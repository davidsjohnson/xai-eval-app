...
function csv_json_get_additional_attributes(page_nr)
{
    ...
    concept_card_1_caption  = "Example:"    + input.Example1_Caption[index];

    concept_card_2_title    = "Example 2";
    concept_card_2_image    = "img/"        + input.Example2[index];
    concept_card_2_caption  = "Example:"    + input.Example2_Caption[index];

    concept_card_3_title    = "Example 3";
    concept_card_3_image    = "img/"        + input.Example3[index];
    concept_card_3_caption  = "Example:"    + input.Example3_Caption[index];

...
function db_get_additional_attributes(page_number)
{
...
function db_get_additional_attributes(study_id, page_number)
{
...
function db_get_all_attributes_and_set_in_html_page(study_id)
{
    ...
    attr = db_get_additional_attributes(g_curr_page_number);
